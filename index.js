...
function createMenuItem(val1, val2, val3) {
  return { name: val1, price: val2, category: val3 };
}
...
*/
console.log("task1b object1", createMenuItem("pizza", 5, "lunch"));
console.log("task1b object2", createMenuItem("hot sandwich", 3.5, "lunch"));
console.log(
  "task1b object3",
  createMenuItem("cheeseburger", 6.5, "lunch/dinner")
);
